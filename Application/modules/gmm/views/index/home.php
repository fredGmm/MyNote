...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        <a href="/admin/index/index">
            ...
            <div class="my-header-logo">运营后台</div>
        </a>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
                <li class="layui-nav-item  layui-nav-itemed">
                    <a href="javascript:;"><i class="layui-icon">&#xe620;</i>管理菜单</a>
                    <dl class="layui-nav-child">

                        <dd><a href="javascript:;" href-url="/admin/index/publish"><i class="layui-icon">&#xe621;</i>发布职位</a></dd>

                        <dd><a href="javascript:;" href-url="/admin/index/job-list"><i class="layui-icon">&#xe621;</i>兼职列表</a></dd>

                        <dd><a href="javascript:;" href-url="/admin/index/apply-list"><i class="layui-icon">&#xe621;</i>报名列表</a></dd>

                        <dd><a href="javascript:;" href-url="/gmm/index/item-list"><i class="layui-icon">&#xe621;</i>原图管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe628;</i>扩展</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="demo/login.html"><i class="layui-icon">&#xe621;</i>公众号</a></dd>
                        <dd><a href="javascript:;" href-url="demo/login.html"><i class="layui-icon">&#xe621;</i>榜单</a></dd>
...
<!--                        <dd><a href="javascript:;" href-url="demo/tips.html"><i class="layui-icon">&#xe621;</i>提示页</a></dd>-->
                ...
                <li class="layui-nav-item"><a target="_blank" href="/"><i class="layui-icon">&#xe61e;</i>乐橙</a></li>
            </ul>
        ...
        <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe id="iframe" src="/admin/index/console" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<div class="my-pay-box none">
    <div><img src="/layui/frame/static/image/zfb.png" alt="支付宝"><p>支付宝</p></div>
    <div><img src="/layui/frame/static/image/wx.png" alt="微信"><p>微信</p></div>
</div>
...
<script type="text/javascript">
    layui.use(['layer','vip_nav'], function () {
        ...
        vipNav.top_left('/layui/json/nav_top_left.json','side-top-left',false);
        // 主体菜单生成 [请求地址,过滤ID,是否展开,携带参数]
        vipNav.main('/layui/json/nav_main.json','side-main',true);
